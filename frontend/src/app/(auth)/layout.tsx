  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center p-4">
      ...
      <Link href="/" className="flex items-center gap-2 mb-8 group">
        ...
        <span className="text-[#FAFAFA] font-bold text-2xl tracking-tight">
          ViralFlux
        </span>
      </Link>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="relative bg-[#111111] border border-[#222222] rounded-2xl p-8 shadow-2xl">
          {children}
        </div>
      </div>

      {/* Footer */}
      <p className="mt-6 text-[#555555] text-xs text-center">
