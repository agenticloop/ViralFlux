        ...
        <div className="flex gap-3 justify-center">
          {otp.map((digit, i) => (
            <input
              ...
              onPaste={handlePaste}
              className={`w-12 h-14 text-center text-xl font-bold rounded-xl border bg-[#111111] text-[#FAFAFA] focus:outline-none transition-all ${
                digit
                  ? "border-[#E5192A] ring-1 ring-[#E5192A]"
                  : "border-[#333333] focus:border-[#E5192A] focus:ring-1 focus:ring-[#E5192A]"
              }`}
            />
          ))}
        </div>
